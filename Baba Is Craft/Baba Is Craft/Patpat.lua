...
patpat.functions = {
    ...
    onPat = {
        default = function ()
            if player:getVehicle(true) then
                animations.BabaIsYouFigura.SitPat:setPlaying(true)
            else
                animations.BabaIsYouFigura.Crouch:setPlaying(false)
                animations.BabaIsYouFigura.Walk:setPlaying(false)
                animations.BabaIsYouFigura.Patpat:setPlaying(true)
            end
        end
    },
    ...
    onUnpat = {
        default = function ()
            if player:getVehicle(true) then
                animations.BabaIsYouFigura.SitPat:setPlaying(false)
            else
                animations.BabaIsYouFigura.Patpat:setPlaying(false)
            end
        end
    },
    ...
    whilePat = {
        default = function (petters) -- petters = list of entities patting you. named petters to keep backwards compat.
            animations.BabaIsYouFigura.Crouch:setPlaying(false)
            animations.BabaIsYouFigura.Walk:setPlaying(false)
            animations.BabaIsYouFigura.Sit:setPlaying(false)
        end
    },
